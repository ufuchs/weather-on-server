...
(function () {
    ...
    ************************************/
    ...
    svgEngine = {
        ...
        createForecast : function (p, dayNum, singleDayDisplay) {
            ...
            function createSun(fc) {
                ...
                return {
                    ...
                    dl : localizeSun(fc.sun.timeOverHorizont, 'dayLenght'),
                    dld : utils.fillTemplates(i18n.__('dayLenghtDiff'), {
                        min : that.astro.formatDayLengthDiff(fc.sun.dld)
                    })
                };
            }
        ...
        prepare : function (aProvider, aAstroProvider) {
            provider = aProvider;
            this.astro = aAstroProvider;
        },
