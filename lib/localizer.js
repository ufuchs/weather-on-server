...
(function (undefined) {
    ...
    function header(localized) {
        ...
        localized.forecastday[0] = { name : today };
        // 29 Mar
    ...
    //
    //
    function forecastDays(localized) {
        ...
        for (i = 0; i < 4; i += 1) {
            ...
            w_forecastday = weather.forecastday[i];
            ...
            case 1:
                w_forecastday.name = tomorrow;
                localized.forecastday[i] = w_forecastday;
                break;

            case 2:
                w_forecastday.name = moment(date).add(duration).add(duration).format('dddd');
                localized.forecastday[i] = w_forecastday;
                break;

            case 3:
                w_forecastday.name = moment(date).add(duration).add(duration).add(duration).format('dddd');
                localized.forecastday[i] = w_forecastday;
                break;
