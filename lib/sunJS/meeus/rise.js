...
rise.interpol = function (r) {
    ...
    var m0 = r.m[0],    // transit
        ...
        n0 = m0 + (r.deltaT / 86400),
        n1 = m1 + (r.deltaT / 86400),
        n2 = m2 + (r.deltaT / 86400);
    ...
    var alpha0 = base.interpol(r.alpha, n0),
        alpha1 = base.interpol(r.alpha, n1),
        alpha2 = base.interpol(r.alpha, n2),

        // no delta
//        H0 = base.pmod(gmstM0 - r.L - alpha0, 360),
        ...
        H1 = base.pmod(gmstM1 - r.L - alpha1, 360),
