...
rise.interpol = function (c, v, m, H0) {
    ...
    var m0 = m[0],      // transit
        ...
        alpha0 = base.interpol(v.alpha, n0),
        alpha1 = base.interpol(v.alpha, n1),
        alpha2 = base.interpol(v.alpha, n2),

        // there is no 'delta0' to calc
        delta1 = base.interpol(v.delta, n1),
        delta2 = base.interpol(v.delta, n2),
