...
julian.J2000 = 2451545.0;  // Julian Day number corresponding to January 1.5 year 2000.
julian.JCENTURY = 36525;   // in days
...
// @param {dec} Number - Decimal places of a Julian Day number
// @return Array - [hour, min, sec.msec]
julian.dec2hhmmssA = function (dec) {

    var t = julian.dec2hhmmss(dec);
...
julian.j2000Century = function(jd, ΔT) {
    ...
    // (22.1) p. 143.
    // (25.1) p. 163.
    return (jd + (ΔT / 86400) - julian.J2000) / julian.JCENTURY;
