...
rise.interpol = function (r) {
    ...
    function calcdeltaM (H, h, h0, phi, delta) {
        ...
        function forRiseOrSet (H, h, delta, h0, phi) {
            ...
            return (h - h0) / 360.0 * cos(delta) * cos(phi) * sin(H);
        }

        function forTransit (H) {
            return - (H0 / 360.0);
        }
        ...
        if (arguments.length === 1) {
            ...
            return forRiseOrSet (H, h, h0, phi, delta);
        }
    ...
    var m0 = r.m[0],    // transit
        ...
        // no delta
        // no altitude
        deltaM0 = calcdeltaM(H0);
        */
        y = r.m.map(function (m) {

            var gmst = base.pmod(r.gast0 + 360.985647 * m, 360.0),
                n = m + r.deltaT,
                alpha = base.interpol(r.alpha, n),
                H = gmst - r.L - alpha,
                delta,
                h,
                deltaM;
                ...
                if (i === 0) {
                    ...
                    delta = base.interpol(r.delta, n),
                    h = calcAltitude(r.phi, delta, H),
                    deltaM = calcdeltaM(H, h, delta, r.h0, r.phi);
                }
        ...
        /*
        // rise
        var gmstM1 = base.pmod(r.gast0 + 360.985647 * m1, 360.0),
        n1 = m1 + r.deltaT,
        ...
        deltaM1 = calcdeltaM(H1, h1, delta1, r.h0, r.phi),
        ...
        deltaM2 = calcdeltaM(H2, h2, delta2, r.h0, r.phi, delta2);
        */
