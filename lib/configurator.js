...
(function () {
    ...
    function configurePngFilenames(cfg) {
        ...
        p.targetDir = appCfg.getTargetDir(r.device, r.id.toString());
        p.crushed = appCfg.getCrushed(r.device);
        p.singleDayDisplay = appCfg.getSingleDayDisplay(r.device);
        p.basename = appCfg.getPngFilename();
