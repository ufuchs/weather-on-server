...
var fs = require('fs.extra'),
    ...
    renderService = require('./svg2png-renderer.js');
...
(function () {
    ...
    function writeResults(wfo) {
        ...
        fs.writeFile(wfo.filenames.out.weatherSvg, wfo.svg, function (err) {
            ...
            if (err) {
                ...
                deferred.resolve(renderService.render({device : wfo.location.device, out : wfo.filenames.out}));
            }
    ...
    //
    //
    function processWeatherdata(params) {

        var maxFiles = cfg.production.files.quantity[params.location.device],
            files = [],
