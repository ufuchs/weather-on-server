...
(function (undefined) {
    ...
    function targetDirname(params) {
        ...
        params.filenames.out.targetDir  = path.resolve(weatherDir
    ...
    function weatherFilenames(params) {
        ...
        params.filenames['in'].svgTemplate = path.resolve(templatesDir
            + '/'
    ...
    filenames.get = function (location, cb) {
        ...
        var deviceDir = path.resolve(weatherDir + '/' + location.device);
