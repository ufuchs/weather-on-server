...
(function () {
    ...
    function Provider(remoteProvider) {
        ...
        // ?
        provider = this.remoteProvider || localProvider;

        if (aRemoteProvider === undefined || aRemoteProvider === null) {
    ...
    provider = function (aRemoteStorage) {
        return new Provider(aRemoteStorage);
    };
