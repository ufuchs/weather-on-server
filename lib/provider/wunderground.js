...
var utils = require('../utils.js'),
    WeatherProvider = require('./providers.js').WeatherProvider;
...
(function (undefined) {
    ...
    Wunderground.prototype = Object.create(WeatherProvider.prototype);

    Wunderground.prototype.extractWeatherFromProviderData = function (aself, aWeather, callback) {

        console.log("invoked: Wunderground#extractWeatherFromProviderData'");
        var
            self = aself,
            weather = aWeather,
...
//        self.getAstroProvider.propertyNames();

        sun = self.getAstroProvider.sun(yesterdaysSun);
