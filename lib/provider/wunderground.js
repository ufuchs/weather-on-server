...
//            weather.countryISO = currObs.display_location.country_iso3166;
            weather.display_location = currObs.display_location;
            weather.estimated = currObs;

            weather.dateEx = forecastday[0].date;

            weather.date = currObs.local_epoch * 1000;
            weather.sun = sunRStoday;
