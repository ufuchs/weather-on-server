...
(function (undefined) {
    ...
    wunderground.extractWeather = function (weatherAsJson, sunTable, callback) {
        ...
        function getSun() {
            ...
            if (sunTable !== null) {
                ...
                sunToday = sunTable[doy].split(' ');
                sunYesterday = sunTable[doy - 1].split(' ');
            ...
            return astro.getSun(sunToday, sunYesterday, sunTable !== null);
    ...
    //
    //
    wunderground.getWeather = function (location, sunTable, cb) {

        get(location, function (jsondata) {

            wunderground.extractWeather(jsondata, sunTable, function (weather) {
                cb(weather);
            });
