...
rise.interpol = function (r) {
    ...
    var m0 = r.m[0],    // transit
        m1 = r.m[1],    // rise
        m2 = r.m[2],    // set
                        // as fraction of day 'D'

        //  MEEUS, chapter 12
        //  mean sidereal time at Greenwich for any instant
        gmstM0 = base.pmod(r.gast0 + 360.985647 * m0, 360.0),   // transit
        gmstM1 = base.pmod(r.gast0 + 360.985647 * m1, 360.0),   // rise
        gmstM2 = base.pmod(r.gast0 + 360.985647 * m2, 360.0),   // set

        n0 = m0 + r.deltaT,     // transit
        n1 = m1 + r.deltaT,     // rise
        n2 = m2 + r.deltaT,     // set

        alpha0 = base.interpol(r.alpha, n0),    // transit
        alpha1 = base.interpol(r.alpha, n1),    // rise
        alpha2 = base.interpol(r.alpha, n2),    // set

        delta1 = base.interpol(r.delta, n1),    // rise
        delta2 = base.interpol(r.delta, n2),    // set
        ...
        h1 = calcAltitude(r.phi, delta1, H1),   // rise
        h2 = calcAltitude(r.phi, delta2, H2),   // set

        deltaM0 = - (H0 / 360.0),                               // transit
        deltaM1 = calcdeltaM(h1, r.h0, r.phi, delta1, H1),      // rise
        deltaM2 = calcdeltaM(h2, r.h0, r.phi, delta2, H2);      // set
