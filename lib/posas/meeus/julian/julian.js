...
julian.calendarGregorianToJdA = function (yy, mm, dd, hour, min, sec) {
    return julian.calendarGregorianToJd(yy, mm, dd +hhmmss2dec(hour, min, sec));
};
...
julian.localTime2utcTime = function (date) {
    ...
    return {
        ...
        utcSec : date.getUTCSeconds() + date.getUTCMilliseconds()
    };
...
julian.localTime2utcTimeArr = function (date) {
    ...
    return [
        ...
        date.getUTCSeconds() + date.getUTCMilliseconds()    // utcSec
