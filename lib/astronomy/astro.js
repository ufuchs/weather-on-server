...
///////////////////////////////////////////////////////////////////////////////
    ...
    astro.getSun = function (id, sunToday, epoch, cb) {

        var doy,
            sunYesterday = null,
            sunRStoday;

        readSunTable(id, function (err, table) {

            if (table !== null) {

                doy = moment(epoch * 1000).dayOfYear();
                sunToday = table[doy].split(' ');
                sunYesterday = table[doy - 1].split(' ');

            }

            if (err) throw err;

            sunRStoday = sunRS4Today(sunToday, sunYesterday);
