    ...
    localizer = {
        ...
        dayZero : function (p, dayNum, singleDayDisplay) {
            ...
            return when.all([
                ...
                .then(function (day) {
                    p.localized.display.forecast  = day;
                    return p;
                });
        ...
        localize : function (wfo, dayNum) {
            ...
            var singleDayDisplay = wfo.cfg.device.singleDayDisplay;

            return when(this.dayZero({weather : wfo.weather, localized : wfo.localized}, dayNum || 0, singleDayDisplay))
                .then(function (p) {
                    return wfo;
                }, function (err) {
                    console.log(err);
